...
const TEST_NAME = 'Norofftest';
const TEST_VALID_EMAIL = 'Norofftest@noroff.no';
const TEST_TOKEN = "token";
const TEST_PASSWORD = 'Norofftest@noroff.no';
const TEST_INVALID_EMAIL = 'notarealemail@outlook.com';
const JSON_RESPONSE = {
  name: TEST_NAME,
